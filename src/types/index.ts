export type Mood = 'happy' | 'love' | 'normal' | 'sad' | 'excited'

export interface Couple { id: string; name: string; started_date: string; created_at: string }
export interface Profile { id: string; couple_id: string | null; display_name: string; nickname: string | null; avatar_url: string | null; birthday: string | null; created_at: string; updated_at: string }
...
export interface Diary { id: string; couple_id: string; created_by: string; diary_date: string; title: string; content: string; mood: Mood | null; weather: string | null; google_photos_url: string | null; created_at: string; updated_at: string }
export interface SpecialDate { id: string; couple_id: string; title: string; event_date: string; repeat_yearly: boolean; note: string | null; created_by: string; created_at: string }
